...
namespace Unity.FPS.Gameplay
{
    public class ProjectileStandard : ProjectileBase
    {
        ...
        [Tooltip("Ratio of Damage to Force applied to valid RigidBodies.")]
        public float DamageToForceRatio = 1.0f;
        ...
        void OnHit(Vector3 point, Vector3 normal, Collider collider)
        {
            ...
            else
            {
                ...
                // apply force to rigidbodies that aren't totally frozen
                if (collider.TryGetComponent(out Rigidbody body) && body.constraints != RigidbodyConstraints.FreezeAll)
                    body.AddForceAtPosition(Damage * DamageToForceRatio * m_Velocity.normalized, point);
            }
